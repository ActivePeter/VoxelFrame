...
class BlockMesh_Common : public BlockMesh_Base
{
    ...
    /* BlockMesh_Base *******************************************************/
    void getBlockValidTriangles(VertexPoses &vertexPoses, Indices &indices) override;
    ...
    void pushOneFaceVerticesAndIndices_selfPos(
        ...
        std::vector<unsigned int> &indices, unsigned int vertexIndexOffset) override;

    bool hasStandardFace(Block_FaceDirection dir) override
    {
        return true;
    }
...
protected:
    ...
    */
    inline void setFaceVertices(VertexPoses &vertexPoses, uint8_t _0, uint8_t _1, uint8_t _2, uint8_t _3)
    {
        VertexPos model(0, 0, 0);
...
public:
    ...
    */
     ...
     * 以便后续有特殊类型方块可以继承和覆盖
     * ***************************************/
    void setFaceVertexPosOnDir(VertexPoses &vertexPoses, Block_FaceDirection dir);
